...
class WGAN_GP(keras.Model):
    ...
    def replace_weights(self, gen_h5, disc_h5):
        """Replace the generator and discriminator weights with the
        ones stored in the given .h5 files.

        Args:
            gen_h5: path to the .h5 file storing the generator weights
            disc_h5: path to the .h5 file storing the discriminator
                weights
        """
